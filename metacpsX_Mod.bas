...
Range("A1").Value = "Titulo"
'Range("A2").Value = Trim(hoja.Cells(2, "A").Value)
Range("A2").Value = Trim(hoja.Cells(1, "B").Value)
Range("B1").Value = "Resumen"
'Range("B2").Value = Trim(hoja.Cells(3, "A").Value)
...
Range("A2").Value = Trim(hoja.Cells(3, "A").Value)
Range("B1").Value = "Patrocinio"
Range("B2").Value = Trim(hoja.Cells(7, "A").Value)
nomsec = "keycpsi"
guardar nomsec
